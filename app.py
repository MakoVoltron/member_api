...
def protected(f):
    ...
    def decorated(*args, **kwargs):
        ...
        return jsonify({'message' : 'Authentification failed!'}), 403
    return decorated
...
def add_member():
    new_member_data = request.get_json(force=True)
    ...
    return jsonify({'members' : {'name' : new_member['name'] , 'email' : new_member['email'], 'level' : new_member['level'] }})
